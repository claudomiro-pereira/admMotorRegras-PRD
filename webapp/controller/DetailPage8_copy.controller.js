sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    'sap/ui/model/Sorter',
    'sap/ui/model/Filter'
], function (BaseController, MessageBox, Dialog15_UFBloqueado, Utilities, History, Export, ExportTypeCSV, exportLibrary, Spreadsheet, jszipjs, xlsxjs, Sorter, Filter) {
    "use strict";
    ...
    return BaseController.extend("com.sap.build.standard.adminEngine.controller.DetailPage8_copy", {
        ...
        _onOverflowToolbarButtonPress: function (oEvent) {
            ...
            var sDialogName = "Dialog15_UFBloqueado";
            this.mDialog15_UfBloq = this.mDialog15_UfBloq || {};
            var oDialog = this.mDialog15_UfBloq[sDialogName];
            if (!oDialog) {
                oDialog = new Dialog15_UFBloqueado(this.getView());
                this.mDialog15_UfBloq[sDialogName] = oDialog;
