sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    'sap/ui/model/Sorter',
    'sap/ui/model/Filter'
], function (BaseController, MessageBox, Dialog16_FornecBloq, Utilities, History, Export, ExportTypeCSV, exportLibrary, Spreadsheet, jszipjs, xlsxjs, Sorter, Filter) {
    "use strict";
    ...
    return BaseController.extend("com.sap.build.standard.adminEngine.controller.DetailPage8_fornec", {
        ...
        _onOverflowToolbarButtonPress: function (oEvent) {
            var sDialogName = "Dialog16_FornecBloq";
            this.mDialog16 = this.mDialog16 || {};
            var oDialog = this.mDialog16[sDialogName];
            if (!oDialog) {
                oDialog = new Dialog16_FornecBloq(this.getView());
                this.mDialog16[sDialogName] = oDialog;
        ...
        _import: function (file) {
            ...
            if (file && window.FileReader) {
                ...
                reader.onload = function (e) {
                    ...
                    if (oColumns[0] == "fornecedor" && oColumns[1] == "descricao"){
        ...
        handleFilterDialogConfirm: function (oEvent) {
           ...
           /* if (this.customFornecFilter) {
                this.customFornecFilter.forEach((descricao) => {
                    // @ts-ignore
                    var oFilter = new sap.ui.model.Filter("descricao", sap.ui.model.FilterOperator.EQ, descricao);
                    aFilters.push(oFilter);
                });
            }*/
        ...
        onSelectionChangeFornec: function (oEvent) {
            ...
            if (bSelected) {
                ...
                oList.getSelectedContexts().forEach((fornecedor) => {
                    this.customFornecFilter.push(fornecedor.getProperty("fornecedor"))
                })
            } else {
            ...
            if (this.customFornecFilter.length > 0) {
                var oCustomFilter = sap.ui.core.Fragment.byId("DialogFilterFornec", "customFornec")
                // @ts-ignore
                ...
                var oCustomFilter = sap.ui.core.Fragment.byId("DialogFilterFornec", "customFornec")
                console.log(this.customFornecFilter.length)
                oCustomFilter.setFilterCount(this.customFornecFilter.length)
            }
