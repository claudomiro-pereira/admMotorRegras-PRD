    ...
    return BaseController.extend("com.sap.build.standard.adminEngine.controller.MasterPage1", {
        ...
        _onObjectListItemPress: function (oEvent) {
            ...
            return new Promise(function (fnResolve) {
                ...
                } else if (oEvent.getSource().getTitle() == "Fornecedores") {
                    this.doNavigate("DetailPage10", oBindingContext, fnResolve, "");
                } else if (oEvent.getSource().getTitle() == "Troca de Cód.SAP/CNPJ") {
                    this.doNavigate("DetailPage11", oBindingContext, fnResolve, "");
                }else if (oEvent.getSource().getTitle() == "Regiões Bloqueadas") {
                ...
                List: [
                    {
                        ...
                        mainText: "Fornecedores",
                        subText: "Cadastro para a baixa automática"
                    }, {
                        mainText: "Troca de Cód.SAP/CNPJ",
                        subText: "Trocar Cód.SAP/CNPJ do Login do usuário"
                    }, {
                        mainText: "Regiões Bloqueadas",
                        subText: "Regioes que poderão ser Bloqueadas"
                    },{
